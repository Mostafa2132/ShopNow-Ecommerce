            ...
            >
              <div className="mb-6">
                <div className="inline-flex items-center gap-2 bg-purple-600/10 backdrop-blur-sm border border-purple-500/20 rounded-full px-4 py-2 mb-4">
                  <FiGrid className="text-purple-400" size={16} />
                  <span className="text-purple-400 text-sm font-semibold">
                    SUBCATEGORIES
                  </span>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                {subcategories.map((sub, index) => (
                  <motion.div
                    ...
                    className="group bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-xl p-4 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 cursor-pointer"
                  >
                    <h3 className="text-white font-semibold text-sm text-center group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 group-hover:bg-clip-text transition-all duration-300">
                      {sub.name}
                    </h3>
                  </motion.div>
                ))}
